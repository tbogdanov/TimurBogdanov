...
public class BasicElementsTest extends TestBase {
    ...
    public void siteHasBasicElementsTest() {
        ...
        Assert.assertEquals(headerItems.size(), HeaderOptions.getCount());
        ...
        Assert.assertEquals(benefitTextBlocks.size(), Benefits.getCount());
        ...
        // S12: Assert that the iframe exists
        ...
        Assert.assertTrue(driver.findElement(By.cssSelector(".epam-logo")).isDisplayed());
