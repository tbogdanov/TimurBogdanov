...
import static enums.differentElementsNames.Checkboxes.*;
...
@Feature("Smoke tests")
@Story("Different Elements Page UI Test (Failed)")
@Listeners(AllureAttachmentListener.class)
public class ServicePageFailedTest extends TestBase {
    ...
    public void checkHomeDifferentPagesFunctionalityTest() {
        ...
        differentElementsPage.checkCheckboxLogEntries(false, WATER, EARTH);
    }
